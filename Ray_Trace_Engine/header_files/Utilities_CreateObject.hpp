...
public:
  ...
  // -- constructor
  //@brief calls initUtilities_CreateObject function and assigns values to
  //devices struct containing references to devices
  Utilities_CreateObject(VkPhysicalDevice *physicalDevice,
                         VkDevice *logicalDevice,
                         CoreExtensions *coreExtensions, CoreDebug *coreDebug,
                         VkCommandPool commandPool);

  // -- init function that is called in constructor
  void InitUtilities_CreateObject(VkPhysicalDevice *physicalDevice,
                                  VkDevice *logicalDevice,
  ...
  VkBuffer VKCreateBuffer(VkBufferCreateInfo *bufferCreateInfo,
                          VkAllocationCallbacks *allocator, VkBuffer *buffer);

  // -- allocate memory
  // creates VkDeviceMemory object from parameter and returns it
  VkDeviceMemory VKAllocateMemory(VkMemoryAllocateInfo *memoryAllocateInfo,
  ...
  VkImage VKCreateImage(VkImageCreateInfo *imageCreateInfo,
                        VkAllocationCallbacks *allocator, VkImage *image);

  // -- create image view
  //@brief creates image view passed in parameter
  //@return image view passed in parameter
  VkImageView VKCreateImageView(VkImageViewCreateInfo *createInfo,
                                VkAllocationCallbacks *allocator,
  ...
  //@brief creates image view passed in parameter
  //@return image view passed in parameter
  VkSampler VKCreateSampler(VkSamplerCreateInfo *createInfo,
                            VkAllocationCallbacks *allocator,
                            VkSampler *sampler);
  ...
  VkRenderPass VKCreateRenderPass(VkRenderPassCreateInfo *createInfo,
                                  VkAllocationCallbacks *allocator,
  ...
  VkPipelineLayout
  VKCreatePipelineLayout(VkPipelineLayoutCreateInfo *createInfo,
                         VkAllocationCallbacks *allocator,
  ...
  VkPipeline
  VKCreateRaytracingPipeline(VkRayTracingPipelineCreateInfoKHR *createInfo,
                             VkAllocationCallbacks *allocator,
                             VkPipeline *pipeline);
  ...
  VkPipeline VKCreateGraphicsPipeline(VkPipelineCache pipelineCache,
                                      uint32_t createInfoCount,
                                      VkGraphicsPipelineCreateInfo *createInfos,
                                      VkAllocationCallbacks *allocator,
                                      VkPipeline *pipeline) {
    if (vkCreateGraphicsPipelines(*devices.logical, pipelineCache,
                                  createInfoCount, createInfos, allocator,
                                  pipeline) != VK_SUCCESS) {
  ...
  VkFramebuffer
  VKCreateFramebuffer(VkFramebufferCreateInfo *framebufferCreateInfo,
                      VkAllocationCallbacks *allocator,
                      VkFramebuffer *framebuffer) {
    if (vkCreateFramebuffer(*devices.logical, framebufferCreateInfo, nullptr,
  ...
  VkDescriptorPool
  VKCreateDescriptorPool(VkDescriptorPoolCreateInfo *descriptorPoolCreateInfo,
                         VkAllocationCallbacks *allocator,
  ...
  VKCreateDescriptorSetLayout(VkDescriptorSetLayoutCreateInfo *createInfo,
                              VkAllocationCallbacks *allocator,
  ...
  VkDescriptorSet VKAllocateDescriptorSet(
  ...
  VkSemaphore VKCreateSemaphore(VkSemaphoreCreateInfo *semaphoreCreateInfo,
                                VkAllocationCallbacks *allocator,
  ...
  VkFence VKCreateFence(VkFenceCreateInfo *fenceCreateInfo,
                        VkAllocationCallbacks *allocator, VkFence *fence);

  // -- create acceleration structure
  // creates VkAccelerationStructureKHR from parameter and returns it
  VkAccelerationStructureKHR VKCreateAccelerationStructureKHR(
