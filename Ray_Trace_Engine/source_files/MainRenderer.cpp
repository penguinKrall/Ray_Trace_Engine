...
void MainRenderer::RetrieveObjectIDFromImage() {
	...
	if (this->pEngineCore->posX < this->pEngineCore->swapchainData.swapchainExtent2D.width && this->pEngineCore->posX > 0) {
		if (this->pEngineCore->posY < this->pEngineCore->swapchainData.swapchainExtent2D.height && this->pEngineCore->posY > 0) {
...
void MainRenderer::CreateShaderBindingTable() {
	...
	try {
		// create buffers
		// raygen
		raygenShaderBindingTable.bufferData.bufferName = "RaygenShaderBindingTable";
		...
		// miss
		missShaderBindingTable.bufferData.bufferName = "MissShaderBindingTable";
		...
		// hit
		hitShaderBindingTable.bufferData.bufferName = "HitShaderBindingTable";
