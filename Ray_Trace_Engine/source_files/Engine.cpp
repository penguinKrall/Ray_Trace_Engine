...
namespace gtp {
	...
	void Engine::LoadModel() {
		...
		if (this->UI.modelData.loadModel) {
			...
			gtp::FileLoadingFlags loadingFlags = this->UI.loadModelFlags.flipY ? gtp::FileLoadingFlags::FlipY : gtp::FileLoadingFlags::None |
				this->UI.loadModelFlags.preMultiplyColors ? gtp::FileLoadingFlags::PreMultiplyVertexColors : gtp::FileLoadingFlags::None |
				this->UI.loadModelFlags.preTransform ? gtp::FileLoadingFlags::PreTransformVertices : gtp::FileLoadingFlags::None;

			//call main renderer load model function
			this->renderers.mainRenderer.LoadModel(
				this->renderers.mainRenderer.assets.modelData.loadModelFilepath, loadingFlags);
