...
public:
	...
	struct Assets {
		...
		//static/scene model
		vkglTF::Model* directionCube = nullptr;

		//building glass model
		vkglTF::Model* buildingGlass = nullptr;

		//colored glass texture
		vrt::Texture coloredClassTexture;

		//gondola model
		vkglTF::Model* gondola = nullptr;
	...
	// -- init constructor
	Build_Scene(CoreBase* coreBase);

	// -- init class function
	void Init_Build_Scene(CoreBase* coreBase);
