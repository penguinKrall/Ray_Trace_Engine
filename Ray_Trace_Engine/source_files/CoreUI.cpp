...
void CoreUI::Input(Utilities_UI::ModelData* pModelData) {
	...
	if (ImGui::CollapsingHeader("Add/Delete Model")) {
		...
		//load flags
		ImGui::Checkbox("Pre Multiply Colors", &this->loadModelFlags.preMultiplyColors);
		ImGui::Checkbox("Flip Y", &this->loadModelFlags.flipY);
		ImGui::Checkbox("Pre Transform Vertices", &this->loadModelFlags.preTransform);
		...
		if (ImGuiFileDialog::Instance()->Display("ChooseFileDlgKey")) {
			if (ImGuiFileDialog::Instance()->IsOk()) {
				...
				this->loadModelFlags.loadModelName = ImGuiFileDialog::Instance()->GetFilePathName();
				//this->modelData.loadModel = true;
			}
