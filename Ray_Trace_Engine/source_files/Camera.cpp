...
void Camera::keyCallbackStatic(GLFWwindow* window, int key, int scancode, int action, int mods) {
...
void Camera::windowFocusCallbackStatic(GLFWwindow* focusWindow, int focused) {
	...
	Camera* instance = static_cast<Camera*>(glfwGetWindowUserPointer(focusWindow));
...
void Camera::framebufferResizeCallbackStatic(GLFWwindow* fbufWindow, int width, int height) {
	Camera* instance = static_cast<Camera*>(glfwGetWindowUserPointer(fbufWindow));
	if (instance) {
		// Call the non-static member function
...
void Camera::framebufferResizeCallback(GLFWwindow* fbufWindow, int width, int height) {
