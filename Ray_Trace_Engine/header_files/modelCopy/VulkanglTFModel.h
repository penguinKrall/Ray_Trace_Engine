...
namespace vkglTF
{
	...
	*/
	...
	public:
		...
		// -- init constructor
		Model(CoreBase* coreBase);

		// -- vertices buffer struct
		struct Vertices {
			int count;
			vrt::Buffer buffer;
		};
		...
		std::vector<uint32_t> modelIndexBuffer;

		std::vector<Vertex> modelVertexBuffer;
		
		std::vector<Vertex> tempVertexBuffer;

		//std::vector<glm::mat4> modelJointMatrices;

		// -- update vertex buffer
		void UpdateVertexBuffer(glm::mat4 cameraView, glm::mat4 projection);

		void UpdateVertexBuffer_2(std::vector<vkglTF::Vertex> newVertices);
		...
		void loadImages(tinygltf::Model& gltfModel, CoreBase* coreBase, VkQueue transferQueue);
		void loadMaterials(tinygltf::Model& gltfModel);
		void loadAnimations(tinygltf::Model& gltfModel);
		void loadFromFile(std::string filename, CoreBase* coreBase, VkQueue transferQueue, uint32_t fileLoadingFlags = vkglTF::FileLoadingFlags::None, float scale = 1.0f);
