...
#include "gltfAnim_bufferreferences.glsl"
#include "gltfAnim_geometrytypes.glsl"
...
{ 
	...
	// Apply testMat transformation to hitValue
	//hitValue = (testMat * vec4(hitValue, 1.0)).xyz;
	...
	float dot_product = max(dot(lightVector, normalize(tri.normal)), 0.2);
